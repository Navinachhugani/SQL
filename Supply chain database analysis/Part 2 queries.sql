...
INNER JOIN product_info AS pi ON oi.Item_Id = pi.Product_Id
WHERE LOWER(pi.Product_Name) LIKE '%nike%'
...
HINT: Use product_info, category, and department tables from the Supply chain dataset.
